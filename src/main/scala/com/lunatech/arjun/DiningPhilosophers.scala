package com.lunatech.arjun
  ...
  */
  ...
  final case class Refuse(chopstick: ActorRef) extends DiningHakkerMessage
  final case class Release(hakker: ActorRef) extends DiningHakkerMessage
